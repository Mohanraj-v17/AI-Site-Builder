...
const Myprojects = () => {
          ...
          loading ? (
            ...
            <div className='py-10 min-h-screen'>
              <div className='flex items-center justify-between mb-12'>
                <h1 className='text-2xl font-medium text-white'>Myprojects</h1>
              ...
              <div className='flex flex-wrap gap-3.5'>
                {projects.map((project) => (
                  <div onClick={() => navigate(`/projects/${project.id}`)} key={project.id} className='relative group w-72 max-sm:mx-auto cursor-pointer bg-gray-900/60 border border-gray-700 rounded-lg overflow-hidden shadow-md'>
  ...
  />
            ...
            <div className='flex felx-col items-center justify-center h-[80vh]'>
